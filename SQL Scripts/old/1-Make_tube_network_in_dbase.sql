...
COPY underground_routes from '/home/james/mounts/James/PhD/2 - Routing/Tube/Raw Data/Lines_and_segments_created.csv' DELIMITERS ',' CSV HEADER;
...
SELECT underground_routes.line, underground_routes.section, underground_routes.shortname as start_station, underground_routes.in_order as start_node, underground_routes.the_geom as start_node_geom, a.shortname as end_station, a.in_order as end_node, a.the_geom as end_node_geom INTO temp
...
DROP TABLE IF EXISTS underground_routes_processed;

SELECT *, st_makeline(start_node_geom, end_node_geom) as edge INTO underground_routes_processed
FROM temp
