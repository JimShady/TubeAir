...
map_plot <- aggregate(corrected_concentration ~ tube_diary_stop + line + platform_depth, tube_data[tube_data$species == 'PM25' & tube_data$line == 'Northern' & tube_data$environment == 'CAR',], mean)
...
# Bottom left section
map_plot[map_plot$line == 'Central' & map_plot$station == 'Edgware',c("fake_x", "fake_y")]           <- c(1,2)
map_plot[map_plot$line == 'Central' & map_plot$station == 'Burnt Oak',c("fake_x", "fake_y")]         <- c(2,2)
map_plot[map_plot$line == 'Central' & map_plot$station == 'Colindale',c("fake_x", "fake_y")]         <- c(3,2)
map_plot[map_plot$line == 'Central' & map_plot$station == 'Hendon Central',c("fake_x", "fake_y")]    <- c(4,2)
map_plot[map_plot$line == 'Central' & map_plot$station == 'Brent Cross',c("fake_x", "fake_y")]       <- c(5,2)
map_plot[map_plot$line == 'Central' & map_plot$station == 'Golders Green',c("fake_x", "fake_y")]     <- c(6,2)
map_plot[map_plot$line == 'Central' & map_plot$station == 'Hampstead',c("fake_x", "fake_y")]         <- c(7,2)
map_plot[map_plot$line == 'Central' & map_plot$station == 'Belsize Park',c("fake_x", "fake_y")]      <- c(8,2)
map_plot[map_plot$line == 'Central' & map_plot$station == 'Chalk Farm',c("fake_x", "fake_y")]        <- c(9,2)

map_plot[map_plot$line == 'Central' & map_plot$station == 'Camden Town',c("fake_x", "fake_y")]       <- c(11,3)

# Top left section
map_plot[map_plot$line == 'Central' & map_plot$station == 'High Barnet',c("fake_x", "fake_y")]            <- c(1,4)
map_plot[map_plot$line == 'Central' & map_plot$station == 'Totteridge & Whetstone',c("fake_x", "fake_y")] <- c(2,4)
map_plot[map_plot$line == 'Central' & map_plot$station == 'Woodside Park',c("fake_x", "fake_y")]          <- c(3,4)
map_plot[map_plot$line == 'Central' & map_plot$station == 'West Finchley',c("fake_x", "fake_y")]          <- c(4,4)
map_plot[map_plot$line == 'Central' & map_plot$station == 'Finchley Central',c("fake_x", "fake_y")]       <- c(5,4)
map_plot[map_plot$line == 'Central' & map_plot$station == 'Mill Hill East',c("fake_x", "fake_y")]         <- c(4,3)
map_plot[map_plot$line == 'Central' & map_plot$station == 'East Finchley',c("fake_x", "fake_y")]          <- c(6,4)
map_plot[map_plot$line == 'Central' & map_plot$station == 'Highgate',c("fake_x", "fake_y")]               <- c(7,4)
map_plot[map_plot$line == 'Central' & map_plot$station == 'Archway',c("fake_x", "fake_y")]                <- c(8,4)
map_plot[map_plot$line == 'Central' & map_plot$station == 'Tufnell Park',c("fake_x", "fake_y")]           <- c(9,4)
map_plot[map_plot$line == 'Central' & map_plot$station == 'Kentish Town',c("fake_x", "fake_y")]           <- c(10,4)

# I'M ABOUT HERE BUT NEED TO MAKE THE REST
